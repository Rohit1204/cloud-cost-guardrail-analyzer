...
export const costSummaryFixture: CostSummaryResponse = {
  cost_summary: {
    ...
    month_to_date_invoice_hint: 12.5,
    month_to_date_invoice_hint_currency: "USD",
    invoice_hint_basis: "ce_net_amortized_then_amortized_daily",
    invoice_billing: {
      available: true,
      skipped: false,
      ...
      prior_period: {
        billing_period: { year: 2026, month: 3 },
        invoice_ids: ["inv-1"],
        total_amount: 200.0,
        total_before_tax: 185.0,
        currency: "USD",
        display_basis: "base_currency",
        issued_date: 1712000000000,
      },
      current_period: null,
    },
    currency: "USD",
